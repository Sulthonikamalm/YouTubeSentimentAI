...
async function doRegister() {
  ...
  setStatus(
    "Sentuh sensor sidik jari di laptop Anda saat jendela Windows muncul…",
  );
  let cred;
  try {
...
document.addEventListener("DOMContentLoaded", async () => {
  // AUTO DEMO MODE FOR VERCEL — langsung masuk dashboard, skip form login
  if (
    window.location.hostname.includes("vercel.app") ||
    window.location.hostname.includes("github.io")
  ) {
  ...
  document
    .getElementById("btnFingerprintLogin")
    .addEventListener("click", doFingerprintLogin);
  document
    .getElementById("btnPasswordLogin")
    .addEventListener("click", doPasswordLogin);
